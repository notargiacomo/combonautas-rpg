...
export class MoneyTreasureGenerator implements TreasureGenerator {
  ...
  public generate(ctx: TreasureContext): GeneratedTreasure {
    ...
    if(linhaDinheiroNivel.unidade!.includes("riqueza")){
      ...
      gt = {items: itens, return: dinheiro.toString(),  notes: "T$", report: this.gerarRelatorio(random, linhaDinheiroNivel, dinheiro)};
    } else {
      let contadorMoedas = this.contadorMoedas(linhaDinheiroNivel);
      dinheiro = (ctx.notes?.includes('METADE') ? contadorMoedas/2 : ctx.notes?.includes('DOBRO') ? contadorMoedas*2 : contadorMoedas);
      gt = {items: itens, return: dinheiro.toString(),  notes: linhaDinheiroNivel.unidade, report: this.gerarRelatorio(random, linhaDinheiroNivel, dinheiro)};
    }
  ...
  calcularRiqueza(unidade:string, modificador: boolean): number {
    ...
    if(unidade.includes("menor"))
      riquezas = this.tabelaRiquezaMenor;
    if(unidade.includes("media"))
      riquezas = this.tabelaRiquezaMedia;
    if(unidade.includes("maior"))
      riquezas = this.tabelaRiquezaMaior;
  ...
  tabelaDinheiro = [
    { nd: 0.25, min: 1,  max: 30,  faixa: '01-30',  dinheiro: '—',          multiplicador: 0, randomizador: 0, parcela: 0, potencializador: 0,   unidade: '', modificador: '' },
    { nd: 0.25, min: 31, max: 70,  faixa: '31-70',  dinheiro: '1d6x10 TC',  multiplicador: 1, randomizador: 6, parcela: 0, potencializador: 10,  unidade: 'TC', modificador: '' },
    { nd: 0.25, min: 71, max: 95,  faixa: '71-95',  dinheiro: '1d4x100 TC', multiplicador: 1, randomizador: 4, parcela: 0, potencializador: 100, unidade: 'TC', modificador: '' },
    { nd: 0.25, min: 96, max: 100, faixa: '96-100', dinheiro: '1d6x10 T$',  multiplicador: 1, randomizador: 6, parcela: 0, potencializador: 10,  unidade: 'T$', modificador: '' },
    { nd: 0.5, min: 1,  max: 25,  faixa: '01-25',  dinheiro: '—',          multiplicador: 0, randomizador: 0, parcela: 0, potencializador: 0,     unidade: '', modificador: '' },
    { nd: 0.5, min: 26, max: 70,  faixa: '26-70',  dinheiro: '2d6x10 TC',  multiplicador: 2, randomizador: 6, parcela: 0, potencializador: 10,    unidade: 'TC', modificador: '' },
    { nd: 0.5, min: 71, max: 95,  faixa: '71-95',  dinheiro: '2d8x10 T$',  multiplicador: 2, randomizador: 8, parcela: 0, potencializador: 10,    unidade: 'T$', modificador: '' },
    { nd: 0.5, min: 96, max: 100, faixa: '96-100', dinheiro: '1d4x100 T$', multiplicador: 1, randomizador: 4, parcela: 0, potencializador: 100,   unidade: 'T$', modificador: '' },
