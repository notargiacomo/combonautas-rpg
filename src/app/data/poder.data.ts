  ...
  constructor() {
    this.poderes = [
      ...
      },
      {
        ...
        descricao: `Você se torna imune a fogo. Se fosse sofrer dano mágico de fogo, em vez disso cura PV em quantidade igual à metade desse dano (se já faz isso por outro efeito, cura a quantidade completa).`,
        id_deuses: [18],
      ...
      },
      {
        id: 171,
        nome: 'Adaga Noturna',
        descricao: `Você pode gastar 1 PM para fazer uma arma de perfuração que esteja usando causar +1d6 pontos de dano de frio até o fim da cena. `,
        id_deuses: [16],
        e_poder_magico: true,
        referencias: Referencia.DEUSES,
        paginas: '',
      ...
      },
      {
        ...
        descricao: `Quando uma criatura em alcance curto sob efeito de uma condição de medo morre, você recebe pontos de vida temporários iguais ao dobro do seu ND, que duram até o fim da cena.`,
        id_deuses: [6, 11],
        referencias: Referencia.DEUSES,
        paginas: '',
        tipo: TipoPoder.PODER_CONCEDIDO,
      },
      {
        ...
        descricao: `No início de cada aventura, você pode trocar uma quantidade de poderes (limitada por sua Sabedoria) por poderes diferentes cujos pré-requisitos cumpra. Você não pode trocar este poder.`,
        id_deuses: [17],
        referencias: Referencia.DEUSES,
        paginas: '',
        tipo: TipoPoder.PODER_CONCEDIDO,
      },
      {
        ...
        descricao: `Sua mochila de aventureiro não conta no seu limite de itens vestidos e, se estiver vestindo uma dessas mochilas, você pode usar Sabedoria para estabelecer seu limite de carga (em vez de Força). A critério do mestre, este poder pode ser aplicado a outro item equivalente (como uma mochila de carga).`,
        id_deuses: [19],
        referencias: Referencia.DEUSES,
        paginas: '',
        tipo: TipoPoder.PODER_CONCEDIDO,
      },
      {
        ...
        descricao: `Você recebe um poder de Armadilha do caçador (Tormenta20, p. 50) a sua escolha. Por ser criada a partir de energia divina, essa armadilha pode ser preparada em locais sem os materiais propícios. `,
        id_deuses: [5],
        e_poder_magico: true,
        referencias: Referencia.DEUSES,
        paginas: '',
      ...
      },
      {
        ...
        descricao: `Você pode gastar uma ação de movimento e 2 PM para receber +2 na Defesa e em Intimidação, e redução de corte, frio e trevas 5 até o fim da cena. `,
        id_deuses: [16],
        e_poder_magico: true,
        referencias: Referencia.DEUSES,
        paginas: '',
      ...
      },
      {
        ...
        descricao: `Você recebe +1 nas rolagens de dano e no multiplicador de crítico com armas nas quais é proficiente.`,
        id_deuses: [3],
        referencias: Referencia.DEUSES,
        paginas: '',
        tipo: TipoPoder.PODER_CONCEDIDO,
      },
      {
        ...
        descricao: `Para você, armas naturais são armas favoritas de Megalokk. Você recebe +2 em rolagens de dano com elas, pode usar Abençoar Arma (Tormenta20, p. 57) nelas e, quando usa esse poder ou a magia Armamento da Natureza, pode aplicar seus benefícios a todas as suas armas naturais (sem custo adicional).`,
        id_deuses: [11],
        referencias: Referencia.DEUSES,
        paginas: '',
        tipo: TipoPoder.PODER_CONCEDIDO,
      },
      {
        id: 179,
        nome: 'Armas da Selvageria',
        descricao: `Você considera todas as armas naturais como armas favoritas de Megalokk e recebe +2 em rolagens de dano com elas.`,
        id_deuses: [11],
        referencias: Referencia.DEUSES,
        paginas: '',
        tipo: TipoPoder.PODER_CONCEDIDO,
      },
      {
        ...
        descricao: `Uma vez por busca (Tormenta20, p. 278), você pode rolar novamente um teste recém-realizado (mas deve aceitar o novo resultado) e, quando recebe uma recompensa ou um castigo aleatório por uma busca (incluindo rolagens na Tabela 8-1; Tormenta20, p. 328), rola dois dados e escolhe entre os dois resultados.`,
        id_deuses: [19],
        referencias: Referencia.DEUSES,
        paginas: '',
        tipo: TipoPoder.PODER_CONCEDIDO,
      ...
      },
      {
        ...
        descricao: `Você pode gastar uma ação de movimento e 3 PM para cobrir seu corpo de coral. Até o fim da cena, você recebe +5 na Defesa e, sempre que sofrer um ataque corpo a corpo, o atacante sofre dano de perfuração igual a 1d6 + sua Constituição. Para cada patamar acima de iniciante, esse dano aumenta em +1d6. e`,
        id_deuses: [13],
        e_poder_magico: true,
        referencias: Referencia.DEUSES,
        paginas: '',
      ...
      },
      {
        ...
        descricao: `Você recebe uma perícia treinada. A cada patamar de jogo (Tormenta20, p. 35) acima de iniciante, recebe mais uma perícia treinada.`,
        id_deuses: [15],
        referencias: Referencia.DEUSES,
        paginas: '',
        tipo: TipoPoder.PODER_CONCEDIDO,
      },
      {
        ...
        descricao: `Você pode gastar uma ação padrão e 2 PM para entoar uma canção de superação e paz. Criaturas escolhidas (limitadas por seu Carisma) em alcance curto recebem +2 em testes (exceto testes de ataque) e +3m de deslocamento até o fim da cena. Se uma criatura afetada for executar uma ação hostil, perde esses bônus.`,
        id_deuses: [10],
        referencias: Referencia.DEUSES,
        paginas: '',
        tipo: TipoPoder.PODER_CONCEDIDO,
      ...
      },
      {
        ...
        descricao: `Você aprende e pode lançar Conjurar Monstro e pode lançar e sustentar essa magia sem violar suas Obrigações & Restrições. Caso aprenda novamente essa magia, seu custo diminui em –1 PM.`,
        id_deuses: [11],
        e_poder_magico: true,
        referencias: Referencia.DEUSES,
        paginas: '',
      ...
      },
      {
        ...
        descricao: `Você possui um luminar (veja p. 277) que o acompanha como um parceiro iniciante. Se perder esse luminar, você pode receber outro com uma cerimônia que exige 1 dia e T$ 100 em oferendas.`,
        id_deuses: [8, 10],
        referencias: Referencia.DEUSES,
        paginas: '',
        tipo: TipoPoder.PODER_CONCEDIDO,
      ...
      },
      {
        ...
        descricao: `Você pode gastar uma ação completa para inspirar esperança em uma criatura que possa tocar. Faça um teste de Carisma (CD 10). Se você passar, a criatura recupera 1d4+1 PM. Você só pode usar este poder uma vez por dia numa mesma criatura.`,
        id_deuses: [8],
        referencias: Referencia.DEUSES,
        paginas: '',
        tipo: TipoPoder.PODER_CONCEDIDO,
      },
      {
        ...
        descricao: `Quando faz um teste de Diplomacia para mudar atitude, você pode rolar dois dados e usar o melhor resultado ou ambos (como se tivesse usado mudar atitude duas vezes). Se passar em ambos, as mudanças de atitude são cumulativas.`,
        id_deuses: [10],
        referencias: Referencia.DEUSES,
        paginas: '',
        tipo: TipoPoder.PODER_CONCEDIDO,
      },
      {
        ...
        descricao: `Você soma sua Sabedoria em Furtividade e, para você, lançar magias é um ato pouco chamativo, o que reduz a penalidade para se esconder após conjurar para –10 (mas você ainda precisa de gestos e palavras).`,
        id_deuses: [5],
        referencias: Referencia.DEUSES,
        paginas: '',
        tipo: TipoPoder.PODER_CONCEDIDO,
      },
      {
        id: 195,
        nome: 'Dom da Vontade',
        descricao: `Você recebe +2 em Vontade e, uma vez por cena, quando passa em um teste de Vontade contra um efeito de um inimigo ou de um perigo apresentado pelo mestre, recebe 1d4 PM temporários.`,
        id_deuses: [7],
        referencias: Referencia.DEUSES,
        paginas: '',
        tipo: TipoPoder.PODER_CONCEDIDO,
      ...
      },
      {
        ...
        descricao: `Você pode substituir testes de Diplomacia e Intimidação por Conhecimento.`,
        id_deuses: [15],
        referencias: Referencia.DEUSES,
        paginas: '',
        tipo: TipoPoder.PODER_CONCEDIDO,
      },
      {
        ...
        descricao: `Quando acerta um ataque corpo a corpo, você pode gastar 2 PM. Se fizer isso, a criatura é empurrada 3m em uma direção a sua escolha e fica desprevenida por 1 rodada.`,
        id_deuses: [3, 13],
        referencias: Referencia.DEUSES,
        paginas: '',
        tipo: TipoPoder.PODER_CONCEDIDO,
      },
      {
        ...
        descricao: `Você pode gastar uma ação padrão e 1 PM para cobrir seus braços com chamas com duração sustentada. Nesse estado, seus ataques corpo a corpo causam +1d6 pontos de dano de fogo. `,
        id_deuses: [4, 18],
        e_poder_magico: true,
        referencias: Referencia.DEUSES,
        paginas: '',
      ...
      },
      {
        id: 207,
        nome: 'Júbilo na Dor',
        descricao: `Quando causa ou sofre dano, você recebe redução de dano 1. Esse efeito é cumulativo e limitado por sua Sabedoria e termina se você passar 1 rodada sem causar ou sofrer dano.`,
        id_deuses: [1],
        referencias: Referencia.DEUSES,
        paginas: '',
        tipo: TipoPoder.PODER_CONCEDIDO,
      },
      {
        id: 208,
        nome: 'Jurista Divino',
        descricao: `Você pode usar Sabedoria para Nobreza (em vez de Inteligência) e pode usar essa perícia no lugar de Diplomacia e Intimidação.`,
        id_deuses: [7, 9],
        referencias: Referencia.DEUSES,
        paginas: '',
        tipo: TipoPoder.PODER_CONCEDIDO,
      },
      {
        id: 209,
        nome: 'Magia Caótica',
        descricao: `Quando lança uma magia, você pode gastar +2 PM. Se fizer isso, a CD para resistir a essa magia é calculada com 1d20 + seus modificadores, em vez de 10 + seus modificadores.`,
        id_deuses: [12],
        referencias: Referencia.DEUSES,
        paginas: '',
        tipo: TipoPoder.PODER_CONCEDIDO,
      },
      {
        id: 210,
        nome: 'Magia Piedosa',
        descricao: `Quando lança uma magia que causa dano, você pode fazer com que ela cause dano não letal.`,
        id_deuses: [8, 18],
        referencias: Referencia.DEUSES,
        paginas: '',
        tipo: TipoPoder.PODER_CONCEDIDO,
      },
      {
        id: 211,
        nome: 'Magia Venenosa',
        descricao: `Suas magias com resistência Fortitude recebem o seguinte aprimoramento. +1 PM: além do normal, criaturas que falharem perdem 1d12 PV por veneno, ou 1d6 se passarem na resistência.`,
        id_deuses: [14],
        e_aprimoramento: true,
        referencias: Referencia.DEUSES,
        paginas: '',
      ...
      },
      {
        id: 212,
        nome: 'Manto Ardiloso',
        descricao: `Você aprende a magia Disfarce Ilusório (CD Car). Na primeira vez que interage com alguém enquanto está sob efeito dessa magia, você recebe +10 no teste de Diplomacia para mudar a atitude dela. Caso aprenda novamente essa magia, seu custo diminui em –1 PM. `,
        id_deuses: [14],
        e_poder_magico: true,
        referencias: Referencia.DEUSES,
        paginas: '',
      ...
      },
      {
        id: 213,
        nome: 'Mar Revolto',
        descricao: `Você pode gastar 1 PM para gerar uma aura de 6m de raio com duração sustentada. No início de seus turnos, criaturas a sua escolha na área devem passar em um teste de Acrobacia (CD Sab, +5 se a criatura estiver dentro da água) para não cair. `,
        id_deuses: [13],
        e_poder_magico: true,
        referencias: Referencia.DEUSES,
        paginas: '',
      ...
      },
      {
        ...
        descricao: `Você pode se comunicar com lefeu inteligentes (Int –3 ou maior) livremente e recebe +5 em testes de Diplomacia e Intuição com criaturas da Tormenta e devotos de Aharadak.`,
        id_deuses: [1],
        referencias: Referencia.DEUSES,
        paginas: '',
        tipo: TipoPoder.PODER_CONCEDIDO,
      },
      {
        id: 215,
        nome: 'Mestre de Si',
        descricao: `Você passa automaticamente no primeiro teste de Vontade contra um efeito de um inimigo que fizer a cada cena.`,
        id_deuses: [9],
        referencias: Referencia.DEUSES,
        paginas: '',
        tipo: TipoPoder.PODER_CONCEDIDO,
      },
      {
        ...
        descricao: `Você pode gastar 1 PM para fazer uma ferramenta ou um equipamento de aventura de até T$ 400 aparecer na sua mão ou em um espaço adjacente. O item dura até o fim da cena, ou até deixar sua posse.`,
        id_deuses: [5],
        e_poder_magico: true,
        referencias: Referencia.DEUSES,
        paginas: '',
      ...
      },
      {
        ...
        descricao: `Você pode usar Sabedoria para Pilotagem (em vez de Destreza) e, enquanto estiver em uma embarcação aquática, suas magias divinas custam –2 PM.`,
        id_deuses: [13],
        referencias: Referencia.DEUSES,
        paginas: '',
        tipo: TipoPoder.PODER_CONCEDIDO,
      },
      {
        id: 219,
        nome: 'Nimb',
        descricao: `Você é Nimb. Ou um filho ou filha dele. Ou uma casca de banana na qual ele escorregou certa vez. Você pode gastar uma ação padrão e 2 PM para gerar uma habilidade única. Para isso, role 1d6 em cada coluna abaixo.
          <div class="row">
          <div class="col-sm-12 mt-2 mb-4">
      ...
      },
      {
        ...
        descricao: `Quando usa uma habilidade com custo em PM, você pode pagar o dobro desse custo (após aplicar efeitos que alterem o custo) para aumentar a CD da habilidade em +5. Se pelo menos um alvo passar no teste de resistência, você fica alquebrado. Este poder não pode ser usado em magias, incluindo simuladas.`,
        id_deuses: [5, 12],
        referencias: Referencia.DEUSES,
        paginas: '',
        tipo: TipoPoder.PODER_CONCEDIDO,
      ...
      },
      {
        ...
        descricao: `Você aprende e pode lançar Comando. Caso aprenda novamente essa magia, seu custo diminui em –1 PM. `,
        id_deuses: [15],
        e_poder_magico: true,
        referencias: Referencia.DEUSES,
        paginas: '',
      ...
      },
      {
        id: 224,
        nome: 'Passo Sombrio',
        descricao: `Uma vez por rodada, você pode gastar 2 PM para se teleportar para um espaço desocupado em alcance curto. Se tanto você quanto esse espaço estiverem sob escuridão, o custo deste poder diminui em –1 PM. Você não pode usar este poder se estiver imóvel. `,
        id_deuses: [16],
        e_poder_magico: true,
        referencias: Referencia.DEUSES,
        paginas: '',
      ...
      },
      {
        ...
        descricao: `Você recebe +5 em Intuição e se torna imune a efeitos de ilusão.`,
        id_deuses: [15],
        referencias: Referencia.DEUSES,
        paginas: '',
        tipo: TipoPoder.PODER_CONCEDIDO,
      },
      {
        ...
        descricao: `Você pode gastar 2 PM para receber +2 na Defesa e redução de dano 5 até o fim da cena ou até encerrar este poder (uma ação livre). Enquanto esse efeito estiver ativo, seu deslocamento é reduzido à metade.`,
        id_deuses: [7],
        referencias: Referencia.DEUSES,
        paginas: '',
        tipo: TipoPoder.PODER_CONCEDIDO,
      },
      {
        ...
        descricao: `Você pode gastar uma ação de movimento e uma quantidade de PM (limitada ao círculo de magias a que tem acesso) para tocar em uma criatura capaz de lançar magias. O custo em PM da próxima magia que ela lançar diminui em um valor igual aos PM que você gastou.`,
        id_deuses: [20],
        referencias: Referencia.DEUSES,
        paginas: '',
        tipo: TipoPoder.PODER_CONCEDIDO,
      },
      {
        ...
        descricao: `A CD e os limites de PM de suas habilidades (exceto magias e habilidades que as simulem) aumentam em um valor igual ao seu patamar.`,
        id_deuses: [6],
        referencias: Referencia.DEUSES,
        paginas: '',
        tipo: TipoPoder.PODER_CONCEDIDO,
      ...
      },
      {
        ...
        descricao: `Suas magias que causam dano de fogo e que têm um teste de resistência recebem o seguinte aprimoramento: +1 PM: criaturas que falhem na resistência ficam em chamas e lentas até apagarem as chamas.`,
        id_deuses: [4],
        referencias: Referencia.DEUSES,
        paginas: '',
        tipo: TipoPoder.PODER_CONCEDIDO,
      },
      {
        ...
        descricao: `Você recebe +2 em testes de ataque para quebrar. Quando usa essa manobra, você pode gastar 2 PM. Se você acertar o ataque, o item e seu portador sofrem o efeito de Dissipar Magia, usando o resultado do teste de quebrar como teste de Misticismo e CD para resistir. `,
        id_deuses: [7],
        e_poder_magico: true,
        referencias: Referencia.DEUSES,
        paginas: '',
      ...
      },
      {
        ...
        descricao: `Uma vez por rodada, quando sofre dano de um inimigo, você pode gastar 1 PM. Se fizer isso, ele sofre uma penalidade cumulativa de –2 em testes de ataque e rolagens de dano até o fim da cena. Mental.`,
        id_deuses: [10],
        referencias: Referencia.DEUSES,
        paginas: '',
        tipo: TipoPoder.PODER_CONCEDIDO,
      },
      {
        ...
        descricao: `Você pode gastar 2 PM para gerar uma aura de luz solar com 9m de raio que dura até o fim da cena. Além de sofrer os efeitos de exposição à luz, criaturas dentro da aura perdem toda camuflagem por escuridão e efeitos semelhantes (como da cobertura de sombras do aprimoramento da magia Escuridão). `,
        id_deuses: [4],
        e_poder_magico: true,
        referencias: Referencia.DEUSES,
        paginas: '',
      ...
      },
      {
        ...
        descricao: `Você pode gastar 1 PM para sacar ou guardar uma arma como uma ação livre. Se sacar sua arma e fizer um ataque corpo a corpo no mesmo turno, você recebe +2 nesse teste de ataque e seu dano aumenta em dois passos (apenas uma vez contra cada criatura por cena).`,
        id_deuses: [9],
        referencias: Referencia.DEUSES,
        paginas: '',
        tipo: TipoPoder.PODER_CONCEDIDO,
      },
      {
        ...
        descricao: `Role duas perícias na Tabela 6-6 (Tormenta20, p. 279). Você se torna treinado nelas (se já for, recebe +3 nessa perícia). No começo de cada dia, você pode gastar 3 PM para rolar novas perícias.`,
        id_deuses: [12],
        referencias: Referencia.DEUSES,
        paginas: '',
        tipo: TipoPoder.PODER_CONCEDIDO,
      },
      {
        id: 237,
        nome: 'Sorvo de Mana',
        descricao: `Sempre que falhar no teste de resistência contra uma magia de um inimigo, você recupera uma quantidade de PM igual ao círculo dela.`,
        id_deuses: [20],
        referencias: Referencia.DEUSES,
        paginas: '',
        tipo: TipoPoder.PODER_CONCEDIDO,
      },
      {
        id: 238,
        nome: 'Temor Arcano',
        descricao: `Quando um inimigo em alcance médio sob efeito de uma condição de medo falha em um teste de resistência contra uma de suas magias, você recebe 1 PM temporário cumulativo. Você pode ganhar um máximo de PM temporários por cena igual ao seu nível, e eles desaparecem no fim da cena.`,
        id_deuses: [6],
        referencias: Referencia.DEUSES,
        paginas: '',
        tipo: TipoPoder.PODER_CONCEDIDO,
      },
      {
        ...
        descricao: `Você recebe +2 em Intimidação e na CD de seus efeitos de medo.`,
        id_deuses: [6, 11, 17],
        referencias: Referencia.DEUSES,
        paginas: '',
        tipo: TipoPoder.PODER_CONCEDIDO,
      },
      {
        ...
        descricao: `Você pode gastar uma ação de movimento e 2 PM para fornecer a si mesmo ou a uma criatura adjacente 2d12 PV temporários (que são sempre os primeiros a serem perdidos) e, enquanto os PV temporários durarem, camuflagem leve.`,
        id_deuses: [16],
        e_poder_magico: true,
        referencias: Referencia.DEUSES,
        paginas: '',
      ...
      },
      {
        ...
        descricao: `Quando você usa um efeito de cura, quaisquer pontos de vida excedentes desse efeito se tornam pontos de vida temporários, até um valor máximo igual ao dobro do nível do alvo.`,
        id_deuses: [8],
        referencias: Referencia.DEUSES,
        paginas: '',
        tipo: TipoPoder.PODER_CONCEDIDO,
      },
      {
        ...
        descricao: `Você aprende e pode lançar a magia Caminhos da Natureza. Se aprender essa magia, o custo dela diminui em –1 PM.`,
        id_deuses: [2],
        e_poder_magico: true,
        referencias: Referencia.DEUSES,
        paginas: '',
      ...
      },
      {
        id: 243,
        nome: 'Ushultt',
        descricao: `Escolha um de seus aliados como seu ushultt. Enquanto estiverem em alcance curto um do outro, vocês recebem +2 em testes de ataque e rolagens de dano (esse bônus aumenta para +3 se o ushultt também for duyshidakk). Você pode trocar seu ushultt uma vez por aventura.`,
        id_deuses: [17],
        referencias: Referencia.DEUSES,
        paginas: '',
        tipo: TipoPoder.PODER_CONCEDIDO,
      ...
      },
      {
        ...
        id_raca: [1, 55],
        instrucao: [
          'this.personagem.adicionaNumeroPericiasLivres(1)',
          OpcoesSelecao.RADIO,
          `[{chave: 'Duas Perícias', value: 'this.personagem.adicionaNumeroPericiasLivres(1)'}, {chave: 'Uma Perícia e um Poder Geral', value: "this.personagem.adicionarEspacoSelecaoPoder('Escolha um poder geral (Versátil)')"}]`,
        ],
        referencias: Referencia.BASICO,
        paginas: '19',
      },
      ...
      },
      {
        ...
        descricao:
          'Você pode lançar a magia Controlar Plantas (atributo-chave Sabedoria). Caso aprenda novamente essa magia, seu custo diminui em –1 PM. e',
        tipo: TipoPoder.HABILIDADE_RACA,
      ...
      },
      {
        ...
        descricao:
          'Você pode gastar uma ação de movimento e 1 PM para transformarsua pele em casca de árvore, recebendo +2 na Defesa até o fim da cena.',
        tipo: TipoPoder.HABILIDADE_RACA,
        instrucao: [],
      ...
      },
      {
        ...
        tipo: TipoPoder.HABILIDADE_RACA,
        instrucao: [
          `this.personagem.adicionaSentido('Visão na Penumbra')`,
          `this.personagem.atualizaBonusExtraPericia('PERCEPÇÃO', [{origem: 'Conhecimento das Rochas', bonus: 2, condicao:[], ativo: true}]);`,
          `this.personagem.atualizaBonusExtraPericia('MISTICISMO', [{origem: 'Conhecimento das Rochas', bonus: 2, condicao:[], ativo: true}]);`,
        ],
        ativacao: [],
        referencias: Referencia.BASICO,
        paginas: '21',
      ...
      },
      {
        ...
        tipo: TipoPoder.HABILIDADE_RACA,
        instrucao: [
          `this.personagem.pericias?.forEach(pericia=>{if(pericia.objeto?.exigeFerramenta){pericia.adicionaBonusExtra([{origem: "Engenhoso", bonus: 2, condicao: ['Ferramenta'], ativo:false}])}})`,
        ],
        ativacao: [],
        referencias: Referencia.BASICO,
        paginas: '23',
      ...
      },
      {
        ...
        instrucao: [
          `this.personagem.adicionaSentido('Visão no Escuro')`,
          `this.personagem.adicionaDeslocamento('Escalada', this.personagem.deslocamentos[0].valor)`,
        ],
        ativacao: [],
        referencias: Referencia.BASICO,
        paginas: '23',
      ...
      },
      {
        ...
        tipo: TipoPoder.HABILIDADE_RACA,
        instrucao: [
          `this.personagem.atualizaBonusExtraPericia('FORTITUDE', [{origem: 'Rato das Ruas', bonus: 2, condicao:[], ativo: true}]);`,
        ],
        ativacao: [],
        referencias: Referencia.BASICO,
        paginas: '23',
      ...
      },
      {
        ...
        id_raca: [6],
        instrucao: [
          `this.personagem.atualizaBonusExtraPericia('FORTITUDE', [{origem: 'Cria da Tormenta', bonus: 5, condicao:['Contra efeitos causados por lefeu e pela Tormenta'], ativo: false}]);`,
          `this.personagem.atualizaBonusExtraPericia('REFLEXO', [{origem: 'Cria da Tormenta', bonus: 5, condicao:['Contra efeitos causados por lefeu e pela Tormenta'], ativo: false}]);`,
          `this.personagem.atualizaBonusExtraPericia('VONTADE', [{origem: 'Cria da Tormenta', bonus: 5, condicao:['Contra efeitos causados por lefeu e pela Tormenta'], ativo: false}]);`,
        ],
        ativacao: [],
        referencias: Referencia.BASICO,
        paginas: '24',
      },
      {
        ...
        id_raca: [6],
        instrucao: [
          'this.personagem.adicionaBonusPericiaPoderNaoLocalizado(2, 261, undefined)',
          OpcoesSelecao.RADIO,
          `[{chave: 'Bonus +2 em Duas Perícias', value: 'this.personagem.adicionaBonusPericiaPoderNaoLocalizado(2, 261, undefined)'}, {chave: 'Bonus +2 em Uma Perícias e um Poder da Tormenta', value: "this.personagem.adicionarEspacoSelecaoPoder('Escolha um poder da tormenta (Deformidade)')"}]`,
        ],
        ativacao: [],
        referencias: Referencia.BASICO,
        paginas: '24',
      ...
      },
      {
        ...
        descricao:
          'Você pode lançar uma magia de 1º círculo a sua escolha (atributo-chave Carisma). Caso aprenda novamente essa magia, seu custo diminui em –1 PM. e',
        tipo: TipoPoder.HABILIDADE_RACA,
        id_raca: [8],
        prerequisito_nivel: 1,
      ...
      },
      {
        ...
        tipo: TipoPoder.HABILIDADE_ORIGEM,
        instrucao: [
          `this.personagem.atualizaBonusExtraPericia('ADESTRAMENTO', [{origem: 'Amigo Especial', bonus: 5, condicao:['COM ANIMAIS'], ativo: false}]);`,
        ],
        ativacao: [],
        referencias: Referencia.BASICO,
        paginas: '85',
      ...
      },
      {
        ...
        tipo: TipoPoder.HABILIDADE_ORIGEM,
        instrucao: [
          `this.personagem.atualizaBonusExtraPericia('ATUAÇÃO', [{origem: 'Dom Artístico', bonus: 2, condicao:[], ativo: true}]);`,
        ],
        ativacao: [],
        referencias: Referencia.BASICO,
        paginas: '86 e 87',
      },
      {
        ...
        tipo: TipoPoder.HABILIDADE_ORIGEM,
        instrucao: [
          `this.personagem.atualizaBonusExtraPericia('FORTITUDE', [{origem: 'Esse Cheiro..', bonus: 2, condicao:[], ativo: true}]);`,
        ],
        ativacao: [],
        referencias: Referencia.BASICO,
        paginas: '87 e 88',
      ...
      },
      {
        ...
        tipo: TipoPoder.HABILIDADE_ORIGEM,
        instrucao: [
          `this.personagem.atualizaBonusExtraPericia('LUTA', [{origem: 'Desejo de Liberdade', bonus: 5, condicao:['CONTRA AGARRAR'], ativo: false}]);`,
          `this.personagem.atualizaBonusExtraPericia('FORTITUDE', [{origem: 'Desejo de Liberdade', bonus: 5, condicao:['CONTRA EFEITOS DE MOVIMENTO'], ativo: false}]);`,
          `this.personagem.atualizaBonusExtraPericia('VONTADE', [{origem: 'Desejo de Liberdade', bonus: 5, condicao:['CONTRA EFEITOS DE MOVIMENTO'], ativo: false}]);`,
        ],
        ativacao: [],
        referencias: Referencia.BASICO,
        paginas: '89',
      ...
      },
      {
        ...
        instrucao: [
          `this.personagem.adicionaSentido('Visão no Escuro');`,
          `this.personagem.adicionaImunidade('CANSAÇO', 'Condição');`,
          `this.personagem.adicionaImunidade('METABOLISMO', 'Condição');`,
          `this.personagem.adicionaImunidade('VENENO', 'Condição');`,
        ],
        ativacao: [],
        referencias: Referencia.BASICO,
        paginas: '93',
      ...
      },
      {
        ...
        instrucao: [
          OpcoesSelecao.RADIO,
          `[{chave: 'Pequeno', value: "this.personagem.atualizaTamanho('Pequeno');this.personagem.adicionarAtributoDestreza(1, 1007)"}, {chave: 'Médio', value: "this.personagem.atualizaTamanho('Médio')"}, {chave: 'Grande', value: "this.personagem.atualizaTamanho('Pequeno');this.personagem.adicionarAtributoDestreza(-1, 1007)"}]`,
        ],
        ativacao: [],
        referencias: Referencia.BASICO,
        paginas: '93',
      ...
      },
      {
        ...
        instrucao: [
          `this.personagem.atualizaTamanho('Pequeno')`,
          `this.personagem.atualizarDeslocamento('Terrestre', 6);`,
          `this.personagem.atualizaBonusExtraPericia('ENGANAÇÃO', [{origem: 'Pequeno e Rechonchudo', bonus: 2, condicao:[], ativo: true}]);`,
        ],
        id_raca: [10],
        prerequisito_nivel: 1,
        ativacao: [],
      ...
      },
      {
        ...
        instrucao: [
          `this.personagem.atualizaBonusExtraPericiasSomaAtributoExcetoLutaPontaria({origem: 'Engenhosidade', atributo: 'inteligencia', condicao:['2 PM'], ativo: false});`,
        ],
        ativacao: [],
        id_raca: [11],
        prerequisito_nivel: 1,
      ...
      },
      {
        ...
        descricao: `Escolha dois dos poderes a seguir. Uma vez por patamar, você pode escolher uma bênção no lugar de um poder de classe.
          ...
          <li><b>Prática Arcana.</b> Escolha uma magia arcana de 1º círculo que cause dano do mesmo tipo de sua Herança Dracônica. Você pode lançar essa magia (atributo-chave Inteligência). Caso aprenda novamente essa magia, seu custo diminui em –1 PM. Você pode escolher esta bênção mais de uma vez para outras magias. ✨</li>
      ...
      },
      {
        ...
        descricao: `No 5º nível, escolha entre Conquistar pelos Números e Treino Intensivo.
          <ul>
          <li><i>Conquistar pelos Números.</i> Você recebe um segundo melhor amigo. Uma vez por rodada, quando faz uma ação padrão com um de seus melhores amigos, você pode gastar 3 PM para fazer uma ação padrão com o outro.</li>
          <li><i>Treino Intensivo.</i> Seu melhor amigo recebe +4 PV por nível, redução de dano 5 e um truque. No 11º nível, a RD aumenta para 10 e ele recebe outro truque. No 17º nível, a RD aumenta para 15.</li>
          </ul>
          `,
        referencias: Referencia.BASICO,
        tipo: TipoPoder.HABILIDADE_CLASSE,
      ...
      },
      {
        id: 1453,
        nome: 'Bom Garoto',
        descricao: `Uma vez por rodada, quando seu melhor amigo faz um acerto crítico em combate ou reduz um inimigo a 0 PV em seu turno, você recebe uma ação padrão que só pode usar consigo mesmo. <i>Pré-requisito: 11º nível de treinador.</i>
          `,
        referencias: Referencia.BASICO,
        tipo: TipoPoder.PODER_CLASSE,
        prerequisito_nivel: 11,
      ...
      },
      {
        ...
        descricao: `Quando usa Domar Criatura, você pode gastar +2 PM para mudar os dados de dano para d12 e atingir todos os alvos dentro do alcance. <i>Pré-requisitos: Domador Cativante, 17º nível de treinador.</i>
          `,
        referencias: Referencia.BASICO,
        tipo: TipoPoder.PODER_CLASSE,
        prerequisito_nivel: 17,
      ...
      },
      {
        ...
        descricao: `Quando usa Direcionar, você pode aplicar o bônus ao próximo teste de perícia de outros melhores amigos com a mesma ação ao custo de +1 PM por amigo adicional. O bônus só afeta o teste se ele for feito até o fim do seu turno. <i>Pré-requisito: Conquistar pelos Números.</i>
          `,
        referencias: Referencia.BASICO,
        tipo: TipoPoder.PODER_CLASSE,
        prerequisito_nivel: 2,
      ...
      },
      {
        ...
        descricao: `Você pode se comunicar com criaturas não inteligentes (Int –4 ou –5) por meio de linguagem corporal e vocalizações. Você pode usar Adestramento com essas criaturas para mudar atitude e persuasão (Tormenta20, p. 118).
          `,
        referencias: Referencia.BASICO,
        tipo: TipoPoder.PODER_CLASSE,
        prerequisito_nivel: 2,
      ...
      },
      {
        id: 1465,
        nome: 'Mascote',
        descricao: `Você tem um mascote (veja o quadro). Você pode escolher este poder várias vezes para mascotes diferentes.
          `,
        referencias: Referencia.BASICO,
        tipo: TipoPoder.PODER_CLASSE,
        prerequisito_nivel: 2,
      ...
      },
      {
        ...
        descricao: `Uma vez por rodada, quando você faz uma ação de movimento, seus melhores amigos recebem uma ação de movimento. <i>Pré-requisito: 5º nível de treinador.</i>
          `,
        referencias: Referencia.BASICO,
        tipo: TipoPoder.PODER_CLASSE,
        prerequisito_nivel: 5,
      ...
      },
      {
        ...
        descricao: `Seus melhores amigos usam seu nível de personagem, em vez de seu nível de treinador, para calcular seus PV, modificadores de perícias e Defesa. <i>Pré-requisito: 6º nível de treinador.</i>
          `,
        referencias: Referencia.BASICO,
        tipo: TipoPoder.PODER_CLASSE,
        prerequisito_nivel: 6,
    ...
    this.poderes.push(
      ...
      },
      {
        ...
        <li><i>Ignorância.</i> Quando uma criatura em alcance curto faz um teste de perícia ou usa uma habilidade com CD, você pode gastar 3 PM para impor uma penalidade de –5 nesse teste ou nessa CD (apenas para esse uso). ✨</li>
      ...
      {
        id: 1743,
        nome: 'Chamado da Colmeia',
        descricao: `
        <p>Você pode gastar 1 PM e uma ação padrão para invocar um enxame de abelhas Grande com duração sustentada, que surge em um espaço a sua escolha em alcance médio. O enxame pode passar pelo espaço de outras criaturas e não impede que outras criaturas entrem no espaço dele. No final de seus turnos, o enxame causa 2d6 pontos de dano de perfuração a qualquer criatura em seu espaço (Reflexos CD Sab reduz à metade). Você pode gastar uma ação de movimento para mover o enxame 12m. A cada patamar além de iniciante, você pode gastar +1 PM quando invoca o enxame para aumentar seu dano em +2d6. ✨</p>`,
        referencias: Referencia.GUIA_DEUSES_MENORES,
        tipo: TipoPoder.PODER_CONCEDIDO,
        prerequisito_nivel: 1,
        id_deuses: [31],
