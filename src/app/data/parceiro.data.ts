  ...
  constructor() {
    this.parceiro = [
      ...
      },
      {
        ...
        descricao:
          'Embora kobolds sejam normalmente considerados pestes, sob as circunstâncias certas um kobold solitário pode ser convencido a ajudar um aventureiro. Tal kobold pode servir como um parceiro especial (combatente) que fornece os benefícios a seguir. ',
        chave: ['Pequeno', 'APOIO', 'Combatente'],
        parceiro_patamar: [
          '<b>Iniciante:</b> você recebe +1 em testes de ataque e rolagens de dano contra inimigos que esteja flanqueando (para um total de +3 de ataque).',
          '<b>Veterano:</b> os bônus acima aumentam para +2. ',
          '<b>Mestre:</b> você pode flanquear mesmo criaturas que não podem ser flanqueadas.',
        ],
        referencias: Referencia.AMEACAS,
        pagina: '',
      },
