    ...
    this.itens = [
      {
        ...
        penalidade: 0,
        tracos:['SIMPLES', 'CORPO A CORPO', 'UMA MÃO', 'LEVE', 'DISCRETA', 'ARREMESSO', 'ATAQUE COM DESTREZA'],
      ...
      },
      {
        ...
        alcance: 0,
        penalidade: 0,
        tracos:['MARCIAL', 'CORPO A CORPO', 'DUAS MÃOS', 'ALONGADA'],
      ...
      },
      {
        ...
        alcance: 0,
        penalidade: 0,
        tracos:['MARCIAL', 'CORPO A CORPO', 'DUAS MÃOS'],
      ...
      },
      {
        ...
        penalidade: 0,
        tracos:['MARCIAL', 'A DISTÂNCIA', 'DUAS MÃOS', 'MUNIÇÃO FLECHA', 'MONTADO'],
      ...
      },
      {
        ...
        alcance: Alcance.MEDIO,
        penalidade: 0,
        tracos:['MARCIAL', 'A DISTÂNCIA', 'DUAS MÃOS', 'MUNIÇÃO FLECHA', 'APLICA FORÇA NO DANO'],
      ...
      },
      {
        ...
        alcance: Alcance.MEDIO,
        penalidade: 0,
        tracos:['SIMPLES', 'A DISTÂNCIA', 'UMA MÃO', 'CORPO A CORPO -5'],
      ...
      },
      {
        ...
        alcance: Alcance.MEDIO,
        penalidade: 0,
        tracos:['SIMPLES', 'A DISTÂNCIA', 'UMA MÃO', 'MUNIÇÃO VIROTE', 'RECARREGA AÇÃO MOVIMENTO'],
      ...
      },
      {
        ...
        alcance: Alcance.MEDIO,
        penalidade: 0,
        tracos:['MARCIAL', 'A DISTÂNCIA', 'DUAS MÃOS', 'MUNIÇÃO VIROTE', 'RECARREGA AÇÃO PADRÃO'],
      ...
      },
      {
        ...
        alcance: 0,
        penalidade: 0,
        tracos:['SIMPLES', 'CORPO A CORPO', 'DUAS MÃOS', 'DUPLA 1d6'],
      ...
      },
      {
        ...
        alcance: 0,
        penalidade: 0,
        tracos:['EXÓTICA', 'CORPO A CORPO', 'UMA MÃO', 'ÁGIL', 'VERSÁTIL DERRUBAR DESARMAR', 'ALCANCE 4,5m'],
      ...
      },
      {
        ...
        alcance: 0,
        penalidade: 0,
        tracos:['MARCIAL', 'CORPO A CORPO', 'UMA MÃO', 'ÁGIL'],
      ...
      },
      {
        ...
        alcance: 0,
        penalidade: 0,
        tracos:['SIMPLES', 'CORPO A CORPO', 'UMA MÃO'],
      ...
      },
      {
        ...
        alcance: 0,
        penalidade: 0,
        tracos:['EXÓTICA', 'CORPO A CORPO', 'UMA MÃO', 'ÁGIL', 'MARCIAL DUAS MÃOS 1d12'],
      ...
      },
      {
        ...
        alcance: 0,
        penalidade: 0,
        tracos:['SIMPLES', 'CORPO A CORPO', 'LEVE', 'UMA MÃO'],
      ...
      },
      {
        ...
        alcance: 0,
        penalidade: 0,
        tracos:['MARCIAL', 'CORPO A CORPO', 'UMA MÃO'],
      ...
      },
      {
        ...
        alcance: 0,
        penalidade: 0,
        tracos:['MARCIAL', 'CORPO A CORPO', 'UMA MÃO', 'ÁGIL'], imagem: 'assets/img/item_arma_florete.png',
        referencias: Referencia.BASICO,
        paginas: '144 E 148',        
        tipo: TipoItem.ARMA
      },
      {
        ...
        alcance: 0,
        penalidade: 0,
        tracos:['SIMPLES', 'CORPO A CORPO', 'UMA MÃO', 'LEVE'],
      ...
      },
      {
        ...
        alcance: Alcance.MEDIO,
        penalidade: 0,
        tracos:['SIMPLES', 'CORPO A CORPO', 'UMA MÃO', 'A DISTÂNCIA', 'MUNIÇÃO PEDRA POLIDA', 'MUNIÇÃO PEDRA COMUM 1d3', 'APLICA FORÇA NO DANO'],
      ...
      },
      {
        ...
        alcance: 0,
        penalidade: 0,
        tracos:['EXÓTICA', 'CORPO A CORPO', 'UMA MÃO', 'ADAPTÁVEL 1d10', 'ÁGIL'],
      ...
      },
      {
        ...
        alcance: Alcance.CURTO,
        penalidade: 0,
        tracos:['SIMPLES', 'CORPO A CORPO', 'UMA MÃO', 'ARREMESSO'],
      ...
      },
      {
        ...
        alcance: 0,
        penalidade: 0,
        tracos:['MARCIAL', 'CORPO A CORPO', 'DUAS MÃOS', 'ARREMESSO', 'MONTADO UMA MÃO', 'ALONGADA', 'INVESTIDA MONTADA +2d8 DANO'],
      ...
      },
      {
        ...
        alcance: Alcance.CURTO,
        penalidade: 0,
        tracos:['MARCIAL', 'CORPO A CORPO', 'UMA MÃO', 'LEVE', 'ARREMESSO'],
      ...
      },
      {
        ...
        alcance: 0,
        penalidade: 0,
        tracos:['EXÓTICA', 'CORPO A CORPO', 'UMA MÃO', 'MARCIAL DUAS MÃOS 1d10'],
      ...
      },
      {
        ...
        alcance: 0,
        penalidade: 0,
        tracos:['EXÓTICA', 'CORPO A CORPO', 'DUAS MÃOS', 'DESBALANCEADA'],
      ...
      },
      {
        ...
        alcance: 0,
        penalidade: 0,
        tracos:['MARCIAL', 'CORPO A CORPO', 'UMA MÃO', 'VERSÁTIL DESARMAR'],
      ...
      },
      {
        ...
        alcance: Alcance.MEDIO,
        penalidade: 0,
        tracos:['ARMA DE FOGO', 'CORPO A CORPO', 'DUAS MÃOS', 'MUNIÇÃO BALA','RECARREGA AÇÃO PADRÃO'],
      ...
      },
      {
        ...
        alcance: 0,
        penalidade: 0,
        tracos:['SIMPLES', 'CORPO A CORPO', 'DUAS MÃOS', 'ALONGADA'],
      ...
      },
      {
        ...
        alcance: Alcance.CURTO,
        penalidade: 0,
        tracos:['ARMA DE FOGO', 'A DISTÂNCIA', 'UMA MÃO', 'MUNIÇÃO BALA','RECARREGA AÇÃO PADRÃO'],
      ...
      },
      {
        ...
        alcance: 0,
        penalidade: 0,
        tracos:['SIMPLES', 'CORPO A CORPO', 'DUAS MÃOS'],
      ...
      },
      {
        ...
        alcance: Alcance.CURTO,
        penalidade: 0,
        tracos:['MARCIAL', 'CORPO A CORPO', 'UMA MÃO', 'VERSÁTIL DERRUBAR'],
      ...
      },
      {
        ...
        alcance: 0,
        penalidade: 0,
        tracos:['EXÓTICA', 'CORPO A CORPO', 'UMA MÃO', 'DANO METABOLICO -2 TESTE/DANO 1 RODADA'],
      ...
      },
      {
        ...
        alcance: Alcance.MEDIO,
        penalidade: 0,
        tracos:['ARMA DE FOGO', 'A DISTÂNCIA', 'DUAS MÃOS', 'MUNIÇÃO BALA','RECARREGA AÇÃO PADRÃO'],
      ...
      },
      {
        ...
        alcance: Alcance.CURTO,
        penalidade: 0,
        tracos:['A DISTÂNCIA', 'UMA MÃO', 'ARREMESSO', 'CORPO A CORPO -5'],
      ...
      },
      {
        ...
        penalidade: 0,
        tracos:['ARMA DE FOGO', 'A DISTÂNCIA', 'DUAS MÃOS', 'MUNIÇÃO 2 BALA','RECARREGA AÇÃO COMPLETA', 'ALCANCE AREA CONE 6M'],
      ...
      },
      {
        ...
        alcance: 0,
        penalidade: 0,
        tracos:['EXÓTICA', 'CORPO A CORPO', 'UMA MÃO'],
      ...
      },
      {
        ...
        alcance: 0,
        penalidade: 0,
        tracos:['EXÓTICA', 'DUAS MÃOS', 'MUNIÇÃO BALA','CORPO A CORPO ALONGADA DANO 1d10 CRITICO x3', 'A DISTÂNCIA DANO 2d8 CRÍTICO 19/x3 ALCANCE MÉDIO', 'ARMA DE FOGO', 'RECARREGA AÇÃO PADRÃO', 'HÍBRIDA'],
      ...
      },
      {
        ...
        alcance: 0,
        penalidade: 0,
        tracos:['EXÓTICA','CORPO A CORPO', 'UMA MÃO', 'ÁGIL','VERSÁTIL AGARRAR DESARMAR'],
      ...
      },
      {
        ...
        alcance: 0,
        penalidade: 0,
        tracos:['ARMA LEVE','CORPO A CORPO', 'UMA MÃO', 'ATLETISMO +2 ESCALAR','DUAS ARMAS ATLETISMO ESCALAR 1,5M'],
      ...
      },
      {
        ...
        penalidade: 0,
        tracos:
        ['EXÓTICA', 'UMA MÃO', 'MUNIÇÃO BALA','CORPO A CORPO ÁGIL DANO 1d6 CRITICO 18', 'A DISTÂNCIA DANO 2d6 CRÍTICO 19/x3 ALCANCE CURTO', 'ARMA DE FOGO', 'RECARREGA AÇÃO PADRÃO', 'HÍBRIDA'],
      ...
      },
      {
        ...
        alcance: 0,
        penalidade: 0,
        tracos:['ARMA LEVE','CORPO A CORPO', 'UMA MÃO', 'NÃO-LETAL'],
      ...
      },
      {
        ...
        alcance: 0,
        penalidade: 0,
        tracos:['EXÓTICA','CORPO A CORPO', 'UMA MÃO', 'ÁGIL', 'DANO CRÍTICO d10'],
      ...
      },
      {
        ...
        alcance: Alcance.CURTO,
        penalidade: 0,
        tracos:['ARMA LEVE','A DISTÂNCIA', 'UMA MÃO', 'ATAQUE ADICIONAL CUSTO 1 PM', 'ATAQUE ADICIONAL ARREMESSO MÚLTIPLO CUSTO 0 PM'],
      ...
      },
      {
        ...
        alcance: 0,
        penalidade: 0,
        tracos:['MARCIAL','CORPO A CORPO', 'DUAS MÃOS', 'VERSÁTIL DERRUBAR EMPURRAR'],
      ...
      },
      {
        ...
        alcance: 0,
        penalidade: 0,
        tracos:['ARMA DE FOGO','A DISTÂNCIA', 'UMA MÃO', 'LEVE', 'ERRA RESULTADO IMPAR DANIFICA'],
      ...
      },
      {
        ...
        alcance: Alcance.CURTO,
        penalidade: 0,
        tracos:['SIMPLES','A DISTÂNCIA', 'UMA MÃO', 'MUNIÇÃO DARDOS', 'RESISTIR A VENENOS CD +2'],
      ...
      },
      {
        ...
        alcance: 0,
        penalidade: 5,
        tracos:['PESADA', 'SOB MEDIDA', 'AJUSTAR T$ 200'],
      ...
      },
      {
        ...
        alcance: 0,
        penalidade: 1,
        tracos:['ESCUDO', 'MÃO LIVRE EXCETO ARMA', 'PROFICIÊNCIA ARMAS MARCIAS PARA ATAQUE CORPOR A CORPO', 'CASO ATAQUE PERDE BONUS DEFESA 1 TURNO'],
      ...
      },
      {
        ...
        alcance: 0,
        penalidade: 1,
        tracos:['ESCUDO', 'PROFICIÊNCIA ARMAS MARCIAS PARA ATAQUE CORPOR A CORPO', 'CASO ATAQUE PERDE BONUS DEFESA 1 TURNO'],
      ...
      },
      {
        ...
        alcance: 0,
        penalidade: 2,
        tracos:['LEVE', 'INTIMIDAÇÃO + 1','RESISTIR A EFEITOS DE MEDO CD +1'],
      ...
      },
      {
        ...
        alcance: 0,
        penalidade: 3,
        tracos:['PESADA', 'NÃO REDUZ DESLOCAMENTO USUÁRIO'],
      ...
      },
      {
        ...
        alcance: 0,
        penalidade: 1,
        tracos:['ESCUDO', 'DEFESA +3 ATAQUES A DISNTÂNCIA'],
      ...
      },
      {
        ...
        alcance: 0,
        penalidade: 0,
        tracos:['LEVE', 'FURTIVIDADE +5', 'NÃO PODE RECEBER MELHORIA MATERIAL ESPECIAL'],
      ...
      },
      {
        ...
        alcance: 0,
        penalidade: 0,
        tracos:['CONSUMÍVEL', 'BOLSA DE 20 BALAS'],
      ...
      },
      {
        ...
        alcance: 0,
        penalidade: 0,
        tracos:['CONSUMÍVEL', 'ALJAVA DE 20 FLECHAS'],
      ...
      },
      {
        ...
        alcance: 0,
        penalidade: 0,
        tracos:['CONSUMÍVEL', 'SACO DE COURO DE 20 PEDRAS POLIDAS'],
      ...
      },
      {
        ...
        alcance: 0,
        penalidade: 0,
        tracos:['CONSUMÍVEL', 'ALJAVA DE 20 VIROTES'],
      ...
      },
      {
        ...
        alcance: 0,
        penalidade: 0,
        tracos:['CONSUMÍVEL', 'PACOTE COM 20 DARDOS'],
        imagem: 'assets/img/item_arma_zarabatana.png',
        referencias: Referencia.BASICO,
        paginas: '151',        
        tipo: TipoItem.MUNICAO
