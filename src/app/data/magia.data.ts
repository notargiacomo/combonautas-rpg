  ...
  constructor() {
    this.magias = [
      ...
      },
      {
        ...
        aprimoramentos: [
          ...
          },
          {
            ...
            execucao_complemento: '',
            alcance: AlcanceMagia.CURTO,
            alvo: 'afeta todos os alvos válidos a sua escolha dentro do alcance.',
        ...
        aprimoramentos: [
          {
            ...
            execucao_complemento: '', // se a execução for do ExecucaoMagia.RODADA, descrição para exibição
            alcance: AlcanceMagia.MEDIO,
            alvo: 'área para esfera com 3m de raio e o alvo para criaturas escolhidas',
            alvo_descricao: 'área para esfera com 3m de raio e o alvo para criaturas escolhidas', // descritivo para exibição do alvo
            duracao: DuracaoMagia.CENA,
            duracao_quantidade: 0, // se a duracao for do DuracaoMagia.RODADA, digitar numero rodadas
            descricao_duracao: '', // se a duracao for do DuracaoMagia.RODADA, descrição para exibição
            pericia_resistencia: '',
      ...
      },
      {
        ...
        duracao: DuracaoMagia.VEJA_TEXTO,
        duracao_quantidade: 0,
        descricao_duracao: '',
        pericia_resistencia: '',
        maneira_resistencia: '',
      ...
      },
      {
        ...
        descricao_duracao: '',
        pericia_resistencia: Resistencia.REFLEXOS,
        maneira_resistencia: Resistencia.VEJA_TEXTO,
      ...
      },
      {
        ...
        descricao: `<p>Usando os medos subconscientes do alvo, você cria uma imagem daquilo que ele mais teme. Apenas a própria vítima pode ver o Assassino Fantasmagórico com nitidez; outras criaturas presentes (incluindo o conjurador) enxergam apenas um espectro sombrio.</p>
        <p>Quando você lança a magia, o espectro surge adjacente a você e a vítima faz um teste de Vontade. Se ela passar, percebe que o espectro é uma ilusão e a magia é dissipada. Se falhar, acredita na existência do espectro, que então flutua 18m por rodada em direção à vítima, sempre no fim do seu turno. Ele é incorpóreo e imune a magias (excetomagias que dissipam outras).</p>
      ...
      },
      {
        id: 22,
        nome: 'Augúrio',
        descricao: `<p>Esta magia diz se uma ação que você tomará em breve — no máximo uma hora no futuro — trará resultados bons ou ruins. O mestre rola 1d6 em segredo; com um resultado de 2 a 6, a magia funciona e você recebe uma das seguintes respostas: “felicidade” (a ação trará bons resultados); “miséria” (a ação trará maus resultados); “felicidade e miséria” (para ambos) ou “nada” (para ações que não trarão resultados bons ou ruins).</p>
        <p>Com um resultado 1, a magia falha e oferece o resultado “nada”. Não há como saber se esse resultado foi dado porque a magia falhou ou não. Lançar esta magia múltiplas vezes sobre o mesmo assunto gera sempre o primeiro resultado.</p>
        ...
        aprimoramentos: [
          {
            ...
            tracos: [CirculoMagia.PRIMEIRO_CIRCULO, ExecucaoMagia.MOVIMENTO],
          },
          {
            id: 2,
      ...
      {
        id: 219,
        nome: 'Armadura Gélida',
        descricao: `<p>Esta magia cria uma grossa armadura feita de gelo, protegendo o corpo do usuário, que sofre todos os efeitos de ficar congelado, menos a paralisia. Se ficar em chamas ou sofrer dano de fogo enquanto estiver sob efeito desta magia, o usuário deve fazer um teste de Reflexos (CD 20). Se passar, o efeito da magia se mantém; se falhar, a armadura derrete e você fica arrefecido.</p>
        <p>Você pode gastar uma ação de movimento e 1 PM para “entrar” em uma sombra do seu tamanho ou maior e se teletransportar para outra sombra, também do seu tamanho ou maior, em alcance médio.</p>`,
        escola: EscolasMagia.ABJURACAO,
        tipo: TipoMagia.UNIVERSAL,
        circulo: CirculoMagia.PRIMEIRO_CIRCULO,
        ...
        pericia_resistencia: '',
        maneira_resistencia: '',
        tracos: [TipoMagia.UNIVERSAL, EscolasMagia.ILUSAO, CirculoMagia.PRIMEIRO_CIRCULO],
        referencias: Referencia.DB,
        paginas: '',
        aprimoramentos: [
          {
            id: 1,
            descricao: `<p><b>+1 PM:</b> muda a execução para reação. Em vez do normal, quando sofre um ataque que causa dano de fogo, você cria um escudo mágico de gelo que fornece RD 10 contra esse ataque (cumulativo com o bônus do efeito básico desta magia e de armaduras).</p>`,
            e_aumenta: false,
            tipo: TipoMagia.UNIVERSAL,
            circulo: CirculoMagia.PRIMEIRO_CIRCULO,
            custo: 1,
          ...
          {
            id: 2,
            descricao: `<p><b>+2 PM:</b> além do normal, a armadura também concede +5 na Defesa. Esse bônus é cumulativo com outras magias, mas não com bônus fornecido por armaduras.</p>`,
            e_aumenta: false,
            tipo: TipoMagia.UNIVERSAL,
            circulo: CirculoMagia.PRIMEIRO_CIRCULO,
            custo: 2,
      ...
      },
      {
        ...
        alvo_descricao: 'arma criada em sua mão',
        duracao: DuracaoMagia.CENA,
        duracao_quantidade: 0,
        descricao_duracao: '',
        pericia_resistencia: '',
        ...
        aprimoramentos: [
          ...
          {
            id: 2,
            descricao: `<p><b>+2 PM:</b> a arma, ou sua munição, é recoberta de espinhos. Ela causa +1d6 pontos de dano e o alvo do ataque fica sangrando.</p>`,
            e_aumenta: false,
            tipo: TipoMagia.DIVINA,
            circulo: CirculoMagia.PRIMEIRO_CIRCULO,
            custo: 2,
      ...
      },
      {
        ...
        descricao: `<p>Escolha um tipo de energia entre ácido, eletricidade, fogo ou frio. Uma aura faiscante dessa energia emana de seu corpo — sempre que uma criatura adjacente acertar um ataque corpo a corpo em você, ela sofre 2d6 pontos de dano do tipo escolhido.</p>`,
        escola: EscolasMagia.EVOCACAO,
        tipo: TipoMagia.ARCANA,
        circulo: CirculoMagia.PRIMEIRO_CIRCULO,
        custo: 1,
        ...
        aprimoramentos: [
          {
            id: 1,
            descricao: `<p><b>+2 PM:</b> muda o alcance para toque e o alvo para 1 criatura. Requer 2º círculo.</p>`,
            e_aumenta: false,
            tipo: TipoMagia.ARCANA,
            circulo: CirculoMagia.SEGUNDO_CIRCULO,
            custo: 2,
          ...
          {
            id: 3,
            descricao: `<p><b>+3 PM:</b> muda a energia para essência. Requer 2º círculo.</p>`,
            e_aumenta: false,
            tipo: TipoMagia.ARCANA,
            circulo: CirculoMagia.SEGUNDO_CIRCULO,
            custo: 3,
      ...
      },
      {
        ...
        custo: 1,
        custo_material: 25,
        descricao_material: 'miniaturas em metal de criaturas (T$ 25 por nível do conjurador)',
        execucao: ExecucaoMagia.PADRAO,
        execucao_quantidade: 0,
        execucao_complemento: '',
        alcance: AlcanceMagia.PESSOAL,
        alvo: 'grupo de criaturas conjuradas',
        alvo_descricao: 'grupo de criaturas conjuradas',
        duracao: DuracaoMagia.ESPECIAL,
        duracao_quantidade: 0,
        descricao_duracao: '',
        pericia_resistencia: '',
        maneira_resistencia: '',
      ...
      },
      {
        id: 223,
        nome: 'Arma de Jade',
        descricao: `<p>Esta magia ofertada por Lin-Wu transfere temporariamente para uma arma as qualidades místicas do jade, um raro material de Tamu-ra. A arma é considerada mágica, pode ser sacada e guardada como ação livre e fornece +1 nos testes de ataque e rolagens de dano (isso conta como um bônus de encanto). Contra espíritos, os bônus fornecidos pela magia são dobrados.</p>`,
        escola: EscolasMagia.TRANSMUTACAO,
        tipo: TipoMagia.DIVINA,
        circulo: CirculoMagia.PRIMEIRO_CIRCULO,
        custo: 1,
        ...
        aprimoramentos: [
          {
            id: 1,
            descricao: `<p><b>+1 PM:</b> a arma causa +1d4 de dano de eletricidade.</p>`,
            e_aumenta: false,
            tipo: TipoMagia.DIVINA,
            circulo: CirculoMagia.PRIMEIRO_CIRCULO,
            custo: 1,
      ...
      },
      {
        id: 224,
        nome: 'Aura de Morte',
        descricao: `<p>Uma aura de frio necrótico emana a partir do seu corpo, alimentando-se de sua própria força vital. Quando você lança a magia, e no início de cada um dos seus turnos, você perde 1d6 pontos de vida e cada outra criatura na área perde 2d8 pontos de vida.</p>`,
        escola: EscolasMagia.NECROMANCIA,
        tipo: TipoMagia.ARCANA,
        circulo: CirculoMagia.SEGUNDO_CIRCULO,
        custo: 3,
        ...
        aprimoramentos: [
          ...
          {
            id: 2,
            descricao: `<p><b>+3 PM:</b> adiciona resistência (Fortitude parcial). Além do normal, outras criaturas que percam pontos de vida pela magia devem fazer um teste de Fortitude. Se falharem, não podem recuperar PV por 1 rodada. Requer 3º círculo.</p>`,
            e_aumenta: false,
            tipo: TipoMagia.ARCANA,
            circulo: CirculoMagia.TERCEIRO_CIRCULO,
            custo: 3,
      ...
      },
      {
        ...
        descricao: `<p>Uma mão mágica surge diante do alvo e o esbofeteia na face, ou em outra parte vulnerável, desaparecendo em seguida. O golpe não causa dano, mas é bastante humilhante. Se o alvo falhar na resistência, fica desprevenido por 1 rodada e vulnerável; se passar, fica apenas vulnerável por 1 rodada.</p>`,
        escola: EscolasMagia.EVOCACAO,
        tipo: TipoMagia.DIVINA,
        circulo: CirculoMagia.PRIMEIRO_CIRCULO,
        custo: 1,
        ...
        aprimoramentos: [
          {
            id: 1,
            descricao: `<p><b>+1 PM:</b> alvos que falharem na resistência ficam vulneráveis pela cena.</p>`,
            e_aumenta: false,
            tipo: TipoMagia.DIVINA,
            circulo: CirculoMagia.PRIMEIRO_CIRCULO,
            custo: 1,
          ...
          {
            id: 2,
            descricao: `<p><b>+2 PM:</b> muda o alvo para 1 criatura.</p>`,
            e_aumenta: false,
            tipo: TipoMagia.DIVINA,
            circulo: CirculoMagia.PRIMEIRO_CIRCULO,
            custo: 2,
          ...
          {
            id: 3,
            descricao: `<p><b>+2 PM:</b> em vez do normal, a mão dá leves tapinhas que acalmam os alvos e anulam uma condição entre abalado, alquebrado, apavorado e frustrado. Requer 2º círculo.</p>`,
            e_aumenta: false,
            tipo: TipoMagia.DIVINA,
            circulo: CirculoMagia.SEGUNDO_CIRCULO,
            custo: 2,
          ...
          {
            id: 4,
            descricao: `<p><b>+3 PM:</b> alvos que falharem na resistência ficam desprevenidos por 1d4+1 rodadas, em vez de apenas 1.</p>`,
            e_aumenta: false,
            tipo: TipoMagia.DIVINA,
            circulo: CirculoMagia.PRIMEIRO_CIRCULO,
            custo: 2,
          ...
          {
            id: 5,
            descricao: `<p><b+5 PM (Apenas Devotos de Nimb):</b> afeta todos os alvos válidos a sua escolha dentro do alcance.</p>`,
            e_aumenta: false,
            tipo: TipoMagia.DIVINA,
            circulo: CirculoMagia.PRIMEIRO_CIRCULO,
            custo: 5,
      ...
      },
      {
        id: 226,
        nome: 'Chuva',
        descricao: `<p>Esta magia só pode ser usada em ambientes abertos. A área é coberta por nuvens, que derramam uma chuva fraca. As intempéries climáticas não são fortes o suficiente para causar penalidades, mas deixam todas as criaturas e objetos dentro da área molhados até que gastem uma ação padrão (ou sofram dano de fogo) para se secar.</p>`,
        escola: EscolasMagia.EVOCACAO,
        tipo: TipoMagia.DIVINA,
        circulo: CirculoMagia.PRIMEIRO_CIRCULO,
        custo: 1,
        ...
        execucao_complemento: '',
        alcance: AlcanceMagia.CURTO,
        alvo: 'cilindro com 9m de raio e 9m de altura',
        alvo_descricao: 'cilindro com 9m de raio e 9m de altura',
        duracao: DuracaoMagia.SUSTENTADA,
        duracao_quantidade: 0,
        descricao_duracao: '',
        pericia_resistencia: '',
        ...
        aprimoramentos: [
          {
            id: 1,
            descricao: `<p><b>+2 PM:</b> a chuva fica ainda mais espessa, causando uma penalidade de –5 em testes de Percepção e em ataques à distância.</p>`,
            e_aumenta: false,
            tipo: TipoMagia.DIVINA,
            circulo: CirculoMagia.PRIMEIRO_CIRCULO,
            custo: 2,
      ...
      },
      {
        ...
        descricao: `<p>Esta magia modifica o terreno e/ou a arquitetura de um ponto no alcance, transformando-o em uma armadilha de caçador (Tormenta20, p. 50) a sua escolha. A armadilha criada segue as mesmas regras de armadilhas, mas a CD dos testes para encontrá-la e resistir a ela é a da magia. Embora seja produzida por magia, a armadilha ainda pode ser superada por meios mundanos normais. Depois de ativada, seja bem-sucedida ou não, a armadilha não volta a se reativar: fica inerte e inofensiva, devendo ser conjurada outra vez.</p>`,
        escola: EscolasMagia.TRANSMUTACAO,
        tipo: TipoMagia.ARCANA,
        circulo: CirculoMagia.SEGUNDO_CIRCULO,
        custo: 3,
        ...
        alvo_descricao: '1 armadilha conjurada',
        duracao: DuracaoMagia.PERMANENTE,
        duracao_quantidade: 0,
        descricao_duracao: '',
        pericia_resistencia: '',
        maneira_resistencia: '',
        tracos: [TipoMagia.ARCANA, EscolasMagia.TRANSMUTACAO, CirculoMagia.SEGUNDO_CIRCULO],
        referencias: Referencia.HEROIS,
        paginas: '',
        aprimoramentos: [
          {
            id: 1,
            descricao: `<p><b>+1 PM:</b> seus poderes que afetam armadilhas também afetam a armadilha criada pela magia.</p>`,
            e_aumenta: false,
            tipo: TipoMagia.ARCANA,
            circulo: CirculoMagia.SEGUNDO_CIRCULO,
            custo: 1,
          ...
          {
            id: 2,
            descricao: `<p><b>+3 PM:</b> quando lança a magia, você pode escolher qualquer número de criaturas no alcance para não serem afetadas pela armadilha. Requer 2° círculo.</p>`,
            e_aumenta: false,
            tipo: TipoMagia.ARCANA,
            circulo: CirculoMagia.SEGUNDO_CIRCULO,
            custo: 3,
          ...
          {
            id: 3,
            descricao: `<p><b>+3 PM:</b> muda a execução para padrão. A armadilha pode ser conjurada diretamente em uma área ocupada por uma criatura, o que a aciona imediatamente. Requer 3º círculo.</p>`,
            e_aumenta: false,
            tipo: TipoMagia.ARCANA,
            circulo: CirculoMagia.TERCEIRO_CIRCULO,
            custo: 5,
          ...
          {
            id: 4,
            descricao: `<p><b>+1 PM (Apenas Armadilheiros Mestres e Caçadores):</b> reduz o tempo de execução para movimento.</p>`,
            e_aumenta: false,
            tipo: TipoMagia.ARCANA,
            circulo: CirculoMagia.TERCEIRO_CIRCULO,
            custo: 1,
          ...
          {
            id: 5,
            descricao: `<p><b>+4 PM (Apenas Armadilheiros Mestres):</b> em vez do normal, você pode conjurar uma das suas armadilhas de armadilheiro mestre.</p>`,
            e_aumenta: false,
            tipo: TipoMagia.ARCANA,
            circulo: CirculoMagia.TERCEIRO_CIRCULO,
            custo: 1,
      ...
      },
      {
        ...
        descricao: `<p>Lisandra de Galrasia foi a primeira a manifestar uma armadura fibrosa, mas hoje outros podem fazer o mesmo. Esta magia transforma o alvo em uma couraça arbórea. Se for uma armadura, seu bônus na Defesa aumenta em +2 e se for um vestuário, passa a fornecer +2 na Defesa (não cumulativo com armadura). Os efeitos desta magia contam como um bônus de encanto e ela só pode ser lançada em terrenos naturais. Dahllan recebem 1 PM para usar em aprimoramentos ao lançá-la.</p>`,
        escola: EscolasMagia.ABJURACAO,
        tipo: TipoMagia.DIVINA,
        circulo: CirculoMagia.SEGUNDO_CIRCULO,
        custo: 3,
        ...
        alvo_descricao: '1 armadura ou vestuário',
        duracao: DuracaoMagia.CENA,
        duracao_quantidade: 0,
        descricao_duracao: '',
        pericia_resistencia: '',
        ...
        aprimoramentos: [
          ...
          {
            id: 2,
            descricao: `<p><b>+2 PM:</b> além do normal, suas magias de evocação e transmutação custam –1 PM.</p>`,
            e_aumenta: false,
            tipo: TipoMagia.DIVINA,
            circulo: CirculoMagia.SEGUNDO_CIRCULO,
            custo: 2,
          ...
          {
            id: 3,
            descricao: `<p><b>+2 PM:</b> o alvo é recoberto por folhas e galhos. Você recebe +5 em testes de Furtividade e pode se esconder mesmo sem camuflagem ou cobertura disponível.</p>`,
            e_aumenta: false,
            tipo: TipoMagia.DIVINA,
            circulo: CirculoMagia.SEGUNDO_CIRCULO,
            custo: 2,
          ...
          {
            id: 4,
            descricao: `<p><b>+2 PM:</b> além do normal, o alvo fornece o mesmo bônus em testes de resistência. Requer 3º círculo.</p>`,
            e_aumenta: false,
            tipo: TipoMagia.DIVINA,
            circulo: CirculoMagia.TERCEIRO_CIRCULO,
            custo: 2,
          ...
          {
            id: 5,
            descricao: `<p><b>+3 PM:</b> além do normal, o alvo é recoberto esporos de cogumelo. Quando uma criatura faz um ataque corpo a corpo contra você, ela deve fazer um teste de Fortitude (CD da magia). Se falhar, fica paralisada por 1 rodada (apenas uma vez por cena) e lenta. Se passar, fica lenta por 1 rodada. Requer 3º círculo.</p>`,
            e_aumenta: false,
            tipo: TipoMagia.DIVINA,
            circulo: CirculoMagia.TERCEIRO_CIRCULO,
            custo: 3,
      ...
      },
      {
        ...
        descricao: `<p>Manipulando energias necromânticas, você concentra sua força vital em uma parte específica do seu corpo. Você recebe fortificação 100% e imunidade a sangramento.</p>`,
        escola: EscolasMagia.NECROMANCIA,
        tipo: TipoMagia.UNIVERSAL,
        circulo: CirculoMagia.TERCEIRO_CIRCULO,
        custo: 6,
        ...
        aprimoramentos: [
          {
            id: 1,
            descricao: `<p><b>+2 PM:</b> muda a duração para 1 dia.</p>`,
            e_aumenta: false,
            tipo: TipoMagia.UNIVERSAL,
            circulo: CirculoMagia.TERCEIRO_CIRCULO,
            custo: 2,
          ...
          {
            id: 3,
            descricao: `<p><b>+4 PM:</b> adiciona componente material (um coração de pedra no valor de T$ 100). Além do normal, quando seus pontos de vida são reduzidos a 0 ou menos, você cura 30 PV e a magia se encerra. Você só pode ser curado por este aprimoramento uma vez por dia.</p>`,
            e_aumenta: false,
            tipo: TipoMagia.UNIVERSAL,
            circulo: CirculoMagia.TERCEIRO_CIRCULO,
            custo: 4,
            custo_material: 100,
            descricao_material: 'um coração de pedra no valor de T$ 100',
            execucao: ExecucaoMagia.PADRAO,
            execucao_quantidade: 0,
            execucao_complemento: '',
            alcance: AlcanceMagia.PESSOAL,
      ...
      },
      {
        ...
        descricao: `<p>Você analisa uma criatura em busca de pontos fracos e outras características. Para isso, como parte do efeito da magia, você faz um teste de Misticismo para identificar criatura contra o alvo (independente do tipo dele) com um bônus de +10.</p>`,
        escola: EscolasMagia.ADVINHACAO,
        tipo: TipoMagia.ARCANA,
        circulo: CirculoMagia.PRIMEIRO_CIRCULO,
        custo: 1,
        ...
        aprimoramentos: [
          ...
          {
            id: 2,
            descricao: `<p><b>+1 PM:</b> além do normal, sua próxima rolagem de dano contra a criatura nessa cena ignora 10 pontos da redução de dano dela. Requer 2° círculo.</p>`,
            e_aumenta: false,
            tipo: TipoMagia.ARCANA,
            circulo: CirculoMagia.SEGUNDO_CIRCULO,
            custo: 1,
          ...
          {
            id: 3,
            descricao: `<p><b>+2 PM:</b> além do normal, você recebe +2 em testes contra a criatura até o fim da cena. Requer 2° círculo.</p>`,
            e_aumenta: false,
            tipo: TipoMagia.ARCANA,
            circulo: CirculoMagia.SEGUNDO_CIRCULO,
            custo: 2,
      ...
      },
      {
        ...
        alvo_descricao: 'você ou 1 objeto',
        duracao: DuracaoMagia.CENA,
        duracao_quantidade: 0,
        descricao_duracao: '',
        pericia_resistencia: '',
        maneira_resistencia: '',
        tracos: [TipoMagia.UNIVERSAL, EscolasMagia.ENCANTAMENTO, CirculoMagia.PRIMEIRO_CIRCULO],
        referencias: Referencia.HEROIS,
        paginas: '',
        aprimoramentos: [
          {
            id: 1,
            descricao: `<p><b>+1 PM:</b> muda o alvo para 1 criatura. Requer 2º círculo.</p>`,
            e_aumenta: false,
            tipo: TipoMagia.UNIVERSAL,
            circulo: CirculoMagia.SEGUNDO_CIRCULO,
            custo: 1,
          ...
          {
            id: 3,
            descricao: `<p><b>+3 PM:</b> além do normal, o alvo não pode ser detectado por magias de adivinhação. Requer 4º círculo.</p>`,
            e_aumenta: false,
            tipo: TipoMagia.UNIVERSAL,
            circulo: CirculoMagia.QUARTO_CIRCULO,
            custo: 3,
      ...
      },
      {
        ...
        descricao: `<p>Esta magia cria uma aura de influência de 9m ao redor do alvo. Outras criaturas que iniciarem seus turnos dentro da aura devem fazer um teste de Vontade. Se falharem, quaisquer ações hostis nesse turno devem ser feitas contra o alvo.</p>`,
        escola: EscolasMagia.ENCANTAMENTO,
        tipo: TipoMagia.ARCANA,
        circulo: CirculoMagia.SEGUNDO_CIRCULO,
        custo: 3,
        ...
        alvo_descricao: '1 criatura voluntária',
        duracao: DuracaoMagia.SUSTENTADA,
        duracao_quantidade: 0,
        descricao_duracao: '',
        pericia_resistencia: '',
        ...
        aprimoramentos: [
          {
            id: 1,
            descricao: `<p><b>+3 PM:</b> muda o alvo para 1 criatura ou objeto. Requer 4° círculo.</p>`,
            e_aumenta: false,
            tipo: TipoMagia.ARCANA,
            circulo: CirculoMagia.QUARTO_CIRCULO,
            custo: 3,
      ...
      },
      {
        ...
        aprimoramentos: [
          {
            id: 1,
            descricao: `<p><b>+1 PM:</b> além do normal, se falhar no teste de Vontade o alvo também sofre –5 em testes de Diplomacia e Intimidação até o fim da cena.</p>`,
            e_aumenta: false,
            tipo: TipoMagia.ARCANA,
            circulo: CirculoMagia.PRIMEIRO_CIRCULO,
            custo: 1,
          ...
          {
            id: 3,
            descricao: `<p><b>+2 PM:</b> em vez de desprevenido, o alvo fica atordoado (apenas uma vez por cena).</p>`,
            e_aumenta: false,
            tipo: TipoMagia.ARCANA,
            circulo: CirculoMagia.PRIMEIRO_CIRCULO,
            custo: 2,
          ...
          {
            id: 4,
            descricao: `<p><b>+2 PM:</b> afeta todos os alvos válidos à sua escolha dentro do alcance. Requer 2º círculo.</p>`,
            e_aumenta: false,
            tipo: TipoMagia.ARCANA,
            circulo: CirculoMagia.SEGUNDO_CIRCULO,
            custo: 2,
            ...
            execucao_complemento: '',
            alcance: AlcanceMagia.CURTO,
            alvo: 'afeta todos os alvos válidos à sua escolha dentro do alcance',
            alvo_descricao: 'afeta todos os alvos válidos à sua escolha dentro do alcance',
            duracao: DuracaoMagia.INSTANTANEA,
            duracao_quantidade: 0,
            descricao_duracao: '',
            pericia_resistencia: '',
      ...
      },
      {
        ...
        execucao_complemento: '',
        alcance: AlcanceMagia.MEDIO,
        alvo: 'esfera com 3m de raio ou 1 criatura ou engenhoca',
        alvo_descricao: 'esfera com 3m de raio ou 1 criatura ou engenhoca',
        duracao: DuracaoMagia.INSTANTANEA,
        duracao_quantidade: 0,
        descricao_duracao: '',
        pericia_resistencia: '',
        ...
        aprimoramentos: [
          {
            id: 1,
            descricao: `<p><b>+2 PM:</b> além do normal, você recebe +5 no seu teste de Misticismo para dissipar uma engenhoca para cada vez que a viu ser usada na cena.</p>`,
            e_aumenta: false,
            tipo: TipoMagia.UNIVERSAL,
            circulo: CirculoMagia.SEGUNDO_CIRCULO,
            custo: 2,
          ...
          {
            id: 2,
            descricao: `<p><b>+5 PM:</b> além do normal, a magia ignora qualquer efeito ativo gerado por engenhocas (por exemplo, um Campo Antimagia).</p>`,
            e_aumenta: false,
            tipo: TipoMagia.UNIVERSAL,
            circulo: CirculoMagia.SEGUNDO_CIRCULO,
            custo: 5,
          ...
          {
            id: 3,
            descricao: `<p><b>+12 PM:</b> muda a área para esfera com 9m de raio. Em vez do normal, cria um efeito de disjunção. Todos os efeitos de engenhocas na área são automaticamente dissipados e todas as engenhocas na área, exceto aquelas que você estiver carregando, enguiçam por uma cena (o usuário de engenhocas carregadas tem direito a um teste de Vontade para evitar isso; engenhocas soltas são itens mundanos e por isso não têm direito a testes, como normal). Requer 5º círculo.</p>`,
            e_aumenta: false,
            tipo: TipoMagia.UNIVERSAL,
            circulo: CirculoMagia.QUINTO_CIRCULO,
            custo: 12,
