  ...
  constructor() {
    this.origens = [
      ...
      },
      {
        ...
        regiao: 'Incomum',
        descricao: `
        <p>Você foi aprendiz de um especialista em ervas, poções e misturas alquímicas, alguém capaz de curar doenças, fabricar elixires e até criar venenos. Na loja de seu mestre, repleta de frascos misteriosos e ingredientes exóticos, você passava os dias triturando raízes, destilando essências e consultando grimórios antigos. Seus clientes variavam de camponeses com males comuns a magos em busca de componentes raros. Seu trabalho não era livre de perigos: ao 
manusear substâncias exóticas, uma dosagem errada podia ser fatal. Talvez você tenha cometido um erro terrível que levou a seu banimento? Seus atuais colegas aventureiros sabem disso?</p>
      ...
      },
      {
        ...
        <p><b>Benefícios.</b> Você é treinado em Furtividade, Investigação e sobrevivência e recebe +2 em testes de perícias contra criaturas de duas categorias de tamanho menor que a sua (mínimo Minúsculas).</p>`,
        referencias: Referencia.HEROIS,
        paginas: '',
        temMagia: false,
        temPoder: false,
      ...
      },
      {
        ...
        <p><b>Itens: </b> Algemas, lampião,  uma arma de até T$ 500 a sua escolha, que você pode ou não ter obtido de um detento.</p>
        <p><b>Benefícios.</b> V. Você recebe +2 em testes contra efeitos mentais, Enganação, Furtividade e Intimidação.</p>`,
        referencias: Referencia.HEROIS,
        paginas: '',
        temMagia: false,
        temPoder: false,
      ...
      },
      {
        ...
        <p><b>Itens: </b> Dente falso (p. 227), instrumentos de barbeiro, maleta de medicamentos.</p>
      ...
      },
      {
        ...
        <p><b>Benefícios.</b> Você é treinado em Fortitude e Ofício (pedreiro). Além disso, sabe encontrar pontos fracos em construções e estruturas. Pode pagar 2 PM para você ou um aliado em alcance curto ignorar 5 pontos da redução de dano de uma criatura ou objeto em alcance curto por uma cena.</p>`,
        referencias: Referencia.HEROIS,
        paginas: '',
        temMagia: false,
        temPoder: false,
      ...
      },
      {
        ...
        <p><b>Benefícios.</b> Você é treinado em Ofício (cozinheiro). Quando prepara um prato especial, seu benefício dura mais 1 dia (se for um benefício com um uso diário, ele pode ser usado novamente nesse dia).</p>`,
        referencias: Referencia.HEROIS,
        paginas: '',
        temMagia: false,
        temPoder: false,
      ...
      },
      {
        ...
        <p><b>Benefícios.</b> Você é treinado em Enganação e Ladinagem. Além disso, escolha uma de suas perícias (exceto Luta ou Pontaria). Você pode usar Carisma como atributo-chave dessa perícia (em vez do atributo original).</p>`,
        referencias: Referencia.HEROIS,
        paginas: '',
        temMagia: false,
        temPoder: true,
      ...
      },
      {
        ...
        regiao: 'Incomum',
        descricao: `
        <p>Você participou de uma das guerras na história recente de Arton, mas não como combatente.  Você forjava armas e armaduras para soldados e oficiais. 
Sua rotina começava antes de o sol nascer, acendendo a forja e moldando o metal incandescente com golpes precisos de seu martelo. Às vezes você lidava com 
materiais raros, como adamante, mitral ou aço-rubi. Entre faíscas e o som do metal sendo trabalhado, você não produzia apenas instrumentos de combate, mas 
também itens cotidianos como ferraduras e pregos, que também salvam vidas e podem decidir batalhas. Muitas vezes também foi visitado por heróis, que pediam 
informações sobre armas lendárias ou reparos em seus equipamentos. Até que, um dia, decidiu acompanhá-los.</p>
        <p><b>Itens: </b> Instrumentos de armeiro, martelo leve (p. 221).</p>
      ...
      },
      {
        ...
        <p><b>Itens: </b> Uma pá (mesmas estatísticas de uma lança), pé de cabra.</p>
      ...
      },
      {
        ...
        regiao: 'Incomum',
        descricao: `
        <p>Você foi passageiro, tripulante ou capitão a bordo de uma embarcação — até que, durante uma longa viagem, ela naufragou. Teria sido uma tempestade, 
abordagem de piratas, ataque de elfos-do-mar, ou mesmo um kaiju? Você sobreviveu, mas acabou isolado em alguma terra remota. Praticamente sem recursos exceto por alguns detritos do naufrágio, precisou achar maneiras de obter sustento e abrigo, além de evitar predadores e bandos selvagens. Não foram tempos fáceis, mas você viveu o bastante para ser encontrado e resgatado. Graças aos deuses, aqueles aventureiros apareceram! Quem sabe, usando as habilidades que aprendeu, você também poderia ser um...?</p>
        <p><b>Itens: </b> Arco curto, 20 flechas, uma bola (ou outro objeto simples) com uma cara pintada e nome de gente.</p>
        <p><b>Benefícios.</b> Você recebe +5 PV e +2 PM. Além disso, uma vez por cena pode gastar 2 PM para receber um dos seguintes benefícios até o fim da cena: treinamento em uma perícia; proficiência com uma arma, armadura ou escudo; usar uma ferramenta no lugar de outra.</p>`,
        referencias: Referencia.HEROIS,
        paginas: '',
        temMagia: false,
        temPoder: false,
...
benefício normal, mas você gasta apenas um item).</p>`,
        referencias: Referencia.HEROIS,
        paginas: '',
        temMagia: false,
        temPoder: false,
      ...
      },
      {
        ...
        regiao: 'Incomum',
        descricao: `
        <p>Ofício muito comum nas áreas costeiras de Arton, bem como nas muitas regiões cortadas pelo Rio dos Deuses e outros grandes cursos d’água. Utilizando 
redes, linhas e anzóis de materiais naturais, você pescava para consumo próprio, para sua família ou para comércio. Enfrentava longas horas em condições adversas nas margens ou embarcado. Dizem que pescadores têm muita paciência, mas a sua talvez tenha se esgotado quando aqueles elfos-do-mar roubaram sua pesca, ou quando os homens-piranhas afundaram seu barco, ou quando os lursh-lyin destruíram sua aldeia. Chega, para tudo há limite!</p>
